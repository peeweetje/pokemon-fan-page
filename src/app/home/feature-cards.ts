import { Swords, BookOpen, GraduationCap, Users, Cpu, Cog } from 'lucide-react';
...
export function getFeatureCards() {
  return featureCardsData;
}

export const featureCards = featureCardsData;
